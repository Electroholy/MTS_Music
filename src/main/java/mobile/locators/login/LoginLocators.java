...
public class LoginLocators {
    ...
    public static final String MTS_TARIFF_NUMBER = "//android.widget.TextView[@resource-id='ru.mts.music.android:id/sdkSsoUserPhone' and @text='+7 915 191-51-90']";
    ...
    public static final String FREEMIUM_TARIFF_NUMBER = "//android.widget.TextView[@resource-id='ru.mts.music.android:id/sdkSsoUserPhone' and @text='+7 915 145-81-59']";
